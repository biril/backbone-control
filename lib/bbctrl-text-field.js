...
define(['underscore', 'backbone', 'bbctrl-base'], function (_, Backbone, Base) {
  ...
  var
    ...
    elMarkup = '\
      <div class="bbctrlTextField">\
        <input type="text" class="bbctrlTextField_input"></input>\
      </div>\
      ';
  ...
  return Base.extend({
    ...
    _updateDisplay: function () {
      Base.prototype._updateDisplay.apply(this, arguments);
      this._doc.$input.prop('disabled', this._uiState.get('isDisabled'));
    },
